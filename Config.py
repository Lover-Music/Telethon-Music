...
class Config(object):
    API_ID = int(os.environ.get("APP_ID", "13861846"))
    API_HASH = os.environ.get("API_HASH", "4001710ae09a26c8326db4776b876d01")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "5657806589:AAFU5COS7-Ao98snL_LX68ucdK_oROlT_i4")
    STRING_SESSION = os.environ.get("STRING_SESSION", "")
    HEROKU_MODE = os.environ.get("HEROKU_MODE", None)
    MANAGEMENT_MODE = os.environ.get("MANAGEMENT_MODE", None)
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "LoverOneBot")
